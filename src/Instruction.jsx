...
//   return (
//     <>
//       <Button onClick={() => props.setOpenModal('default')}>Start Quiz</Button>
...
//           <li>After answering all questions, click 'Submit' to see your results.</li>
//         </ol>
//           </div>
//         </Modal.Body>
//         <Modal.Footer>
...
//           <Button color="gray" onClick={() => props.setOpenModal(undefined)}>Decline</Button>
//         </Modal.Footer>
//       </Modal>
//     </>
//   )
